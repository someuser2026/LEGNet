...
# Submit one PBS job per config in the planet RGB config directories.
#
# Examples:
#   tools/submit_planet_rgb_jobs.sh
#   tools/submit_planet_rgb_jobs.sh --email you@example.com
#   tools/submit_planet_rgb_jobs.sh --config-dir configs/planet_rgb_448
...
CONFIG_DIRS=(
    "configs/planet_rgb_448"
    "configs/planet_rgb_smallobj_896"
)
